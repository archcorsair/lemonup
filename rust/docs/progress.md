...
- the install/search modal is larger and now lets the results pane flex to use available vertical space
- search results now show above/below overflow hints when more matches exist offscreen
